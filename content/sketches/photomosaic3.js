...
function preload() {
    ...
    myShader = loadShader("/vc/sketches/shader.vert", "/vc/sketches/shader3.frag")
}
function setup() {
  W = 500;
  H = 500;
  ...
  myShader.setUniform("alpha0", alpha6);
  myShader.setUniform("alpha1", alpha5);
  myShader.setUniform("alpha2", alpha4);
  myShader.setUniform("alpha3", alpha3);
  myShader.setUniform("alpha4", alpha2);
  myShader.setUniform("alpha5", alpha1);
  myShader.setUniform("alpha6", alpha0);
